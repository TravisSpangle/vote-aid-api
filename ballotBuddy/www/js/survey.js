angular.module('survey', ['ionic', 'firebase'])
	...
	.constant('FBREF', new Firebase('https://dfw-firebase.firebaseio.com/surveyApp/'))
	...
	$stateProvider
		...
		views: {
			'menuContent': {
				...
				controller: 'SurveyController as sCtrl',
			}
		}
	})
		...
		views: {
			'menuContent': {
				...
				controller: 'QuestionsController as qCtrl'
			}
		}
	});

	// if none of the above states are matched, use this as the fallback
	$urlRouterProvider.otherwise('/app/survey');
